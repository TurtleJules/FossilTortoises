...
## W = 22447, p-value = 6.297e-09
## alternative hypothesis: true location shift is less than 0
\end{verbatim}

Wilcoxon Rank Sum Test (unpaired data):

modern \textless{} fossil (P = \(6.2971778\times 10^{-9}\))
...
modern insular \textless{} fossil insular (P = \(0.0011105\))
...
## W = 13644, p-value = 4.891e-05
## alternative hypothesis: true location shift is greater than 0
\end{verbatim}

Wilcoxon Rank Sum Test (unpaired data):

continental \textless{} insular (P = \(4.8905042\times 10^{-5}\))
...
## Kruskal-Wallis chi-squared = 29.643, df = 2, p-value = 3.658e-07
\end{verbatim}

Wilcoxon Rank Sum Test (unpaired data):

Continent means differ (P = \(3.6577135\times 10^{-7}\)) (still have to
