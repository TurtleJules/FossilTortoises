...
## W = 22962, p-value = 3.793e-08
## alternative hypothesis: true location shift is less than 0
\end{verbatim}

Wilcoxon Rank Sum Test (unpaired data):

modern \textless{} fossil (P = \(3.7925942\times 10^{-8}\))
...
## W = 13991, p-value = 6.173e-06
## alternative hypothesis: true location shift is greater than 0
\end{verbatim}

Wilcoxon Rank Sum Test (unpaired data):

continental \textless{} insular (P = \(6.1729949\times 10^{-6}\))
...
## Kruskal-Wallis chi-squared = 32.935, df = 3, p-value = 3.324e-07
\end{verbatim}

Kruskal-Wallis-Test:

Continent means differ (P = \(3.3236569\times 10^{-7}\)) (still have to
