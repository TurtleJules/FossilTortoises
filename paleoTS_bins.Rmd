...
write.table(BINS,file="timebins.txt", sep="\t", row.names = FALSE) 
...
## including Island species, Species mean
...
sumTortoises <- sumTort %>%
  ...
  select(Taxon, MeanBins, n, meanCL, sdCL) %>% 
...
## excluding Island species, Species mean
...
hist(SpeciesMean$meanCL, breaks=20)
