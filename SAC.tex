...
\begin{center}
	\begin{figure}[H]
		...
		\subfloat[South America]{\includegraphics[scale=0.3]{MA_JJ_files/figure-latex/SACGAmerica-1.pdf}}
		\hfill %
		...
		\caption{Sampling Accumulation Curves: (a) - (b) Species are not sufficiently sampled, regardless of sampling unit. (c) - (i) Sampling Accumulation Curves on generic level per continent. Only Europe (h) and Eurasia (i) are sufficiently sampled.}
		\label{fig:lat}
	\end{figure}
\end{center}
