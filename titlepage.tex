\documentclass[toc=bibliographynumbered]{scrartcl} %mit [draft] vor den {} erreicht man, daß statt der Grafiken nur ein Rahmen in Größe der Grafik gezeichnet wird. Zusätzlich wird der Name der einzufügenden Datei in diesen Rahmen geschrieben]{book}
...
%\begin{figure}[t]
\begin{center}
\includegraphics[scale=0.65]{pics/hulogo.pdf}\\[0.5cm]
