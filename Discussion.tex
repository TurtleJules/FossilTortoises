...
DISCUSS human exploitation (Froyd 2014)
...
--> Meiolania were extirpated by humans!!
...
Conclusion: extinction of giant continental fossils accounts for differences in evolutionary patterns for continental and insular species (but do not account for loss of biodiversity!).
- significant size difference and within-lineage tendencies not visible as body size trend
...
Giant tortoises seem to occupy only a small temperature range, since they are in danger of overheating \citep{.}, but also cannot cope with cold winters \citep{.}. However, obviously appropriate climates are still available, since giant tortoises are still present in some places, which means climate alone is unlikely to have driven the extinction, at least not on tropical islands.
