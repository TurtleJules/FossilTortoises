...
#                          "Burdigalian" ,"Fossil", "Modern", "continental", "insular", "fossil-con", "fossil-ins", "modern-con", 
...
hist(FossilRan)
abline(v=median(FossilR$CL))#locates actual statistics (skewness) with all data
