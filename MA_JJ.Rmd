...
```{r "Boxplots of each genus per time bin", echo=FALSE, fig.cap="Boxplots of each genus per time bin, for colors see Fig. 4."}
...
kable(fit3models(paleoGen, silent=FALSE, method="AD", pool=FALSE))
...
kable(fit3models(paleoPPCLIs, silent=FALSE, method="AD", pool=FALSE), caption="Model-fitting results for testudinidae, individuals, including island species")
```
\newpage
...
kable(fit3models(paleoSpecIs, silent=FALSE, method="AD", pool=FALSE))
...
kable(fit3models(paleoGenIs, silent=FALSE, method="AD", pool=FALSE))
