...
bin <- as.vector(unique(Bins$bin))
EpochBins <- as.vector(c("Holocene", "Upper Pleistocene", "Middle Pleistocene", "Lower Pleistocene", "Upper Pliocene", "Lower Pliocene", "Upper Miocene", "Middle Miocene", "Lower Miocene", "Oligocene and Eocene"))
...
Stats <- bind_rows(StatsAll, StatsBins, StatsIsland) %>%
  select(-EpochBins, -Island)
...
Stats$Variable <- c("all", "Modern", "Upper Pleistocene", "Middle Pleistocene", "Lower Pleistocene", "Upper Pliocene", "Lower Pliocene", "Upper Miocene", "Middle Miocene", "Lower Miocene", "Oligocene and Eocene", "continental", "insular")
...
```{r "paleoTS with different time bins", echo=FALSE}
...
AltBins <- as.vector(c( (0+0.0005)/2,(0.0005+1)/2,   (1+2)/2,  (2+3)/2, (3+4)/2,  (4+5)/2, (5+6)/2,   
...
kable(AlterPaleo, caption="Time bins with age range, epoch name, mean age and corresponding sample sizes (on individual, species and genus level)")
