...
paleoPPCLCon <-as.paleoTS(PPCLCon$mm, PPCLCon$vv, PPCLCon$nn, PPCLCon$tt, MM = NULL, genpars = NULL, label = "Testudinidae body size evolution mode")
#paleoPPCL
plot(paleoPPCLCon)
```
...
kable(PaleoPCCLConFit, caption="Model-fitting results for testudinidae, individuals, Africa")
...
kable(PaleoPCCLConFit, caption="Model-fitting results for testudinidae, individuals, Europe")
...
PaleoAmConFit <- (fit3models(paleoAmCon, silent=FALSE, method="AD", pool=FALSE))
```
...
kable(PaleoPCCLConFit, caption="Model-fitting results for testudinidae, individuals, Asia")
