...
number of occurrences according to FosFarBase `r length(unique(FossilOccurrences$Locality))`

number of FosFarBase occurrences for which body size was available `r length(unique(FossilOccurrences$Locality[which(FossilOccurrences$Clavailability=="yes")]))`

number of FosFarBase occurrences of relevant age `r length(unique(FossilOcMiocene$Locality))`

number of FosFarBase occurrences of relevant age for which body size data was available `r length(unique(FossilOcMiocene$Locality[which(FossilOcMiocene$Clavailability=="yes")]))`
