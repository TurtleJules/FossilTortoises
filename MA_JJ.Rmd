...
```{r "paleoTS, individuals, exluding island species", echo=FALSE, fig.cap="individuals, excluding island species"}
PPCLI <- PleiPlioCL %>%
...
```{r "paleoTS plot with species mean, excluding island species", echo=FALSE, fig.cap="paleoTS plot with species mean, excluding island species"}
...
# paleoTS plot with genus mean
```{r "paleoTS plot with genus mean, excluding island species", echo=FALSE, fig.cap="paleoTS plot with genus mean, excluding island species"}
...
```{r "Boxplot continental vs. insular, species summarised", echo=FALSE}
Island <- PleiPlioCL %>%
...
```{r "Boxplots, species summarised", echo=FALSE}
Island <- PleiPlioCL %>%
  dplyr::select(Taxon, CL, PL, Age, Island, Continent, EpochBins) %>%
  merge(Epochs) %>%
  merge(Continents) %>%
