...
Stages <- as.vector(c("Modern", "Upper Pleistocene", "Middle Pleistocene", "Lower Pleistocene", "Lower Pleistocene", "Upper Pliocene", "Lower Pliocene", "Upper Miocene","Upper Miocene",
                      "Middle Miocene","Middle Miocene", "Lower Miocene"))#, "Lower Miocene"


MeanBins <- as.vector(c((0+0.0117)/2, (0.0117+0.126)/2, (0.126+0.781)/2, (0.781+1.806)/2, (1.806+2.588)/2,(2.588+3.6)/2, (3.6+5.332)/2, (5.332+7.246)/2, (7.246+11.608)/2, (11.608+13.82)/2, (13.82+15.97)/2, (15.97+20.44)/2))#, (20.44+23.03)/2
...
```{r "Species Accumulation Curve with Genera, Europe", echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Sampling Accumulation Curve of fossil genera per reference, Europe"}
...
```{r "Species Accumulation Curve with Genera, America", echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Sampling Accumulation Curve of fossil genera per reference, America"}
...
```{r "Species Accumulation Curve with Genera, N-America", echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Sampling Accumulation Curve of fossil genera per reference, N-America"}
...
```{r "Species Accumulation Curve with Genera, S-America", echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Sampling Accumulation Curve of fossil genera per reference, S-America"}
...
```{r "Species Accumulation Curve with Genera, Asia", echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Sampling Accumulation Curve of fossil genera per reference, Asia"}
...
Stats$Variable <- c("all", "Modern", "Upper Pleistocene", "Middle Pleistocene", "Lower Pleistocene", "Gelasian", "Piacencian", "Zanclean", "Messinian","Tortonian", "Serravallian","Langhian",
                         "Burdigalian", "Modern","Fossil", "continental",
                    "insular","modern-con", "modern-ins", "fossil-con", "fossil-ins",
                    "Africa", "America", "Asia", "Europe")#,"Aquitanian"
...
```{r "randon sampling modern fossil", echo=FALSE, include=FALSE}
...
```{r "randon sampling modern fossil, island continental", echo=FALSE, include=FALSE}
...
```{r "randon sampling island continental", echo=FALSE, include=FALSE}
...
```{r "randon sampling continents", echo=FALSE, include=FALSE}
...
```{r "paleoTS with different time bins, no bins, genera, Europe, continental", echo=FALSE, fig.cap="Smaller original bins, genera, Europe, continental"}
...
```{r "paleoTS with different time bins, no bins, genera, Europe, insular", echo=FALSE, fig.cap="Smaller original bins, genera, Europe, insular"}
...
```{r "paleoTS with different time bins, no bins, genera, Eurasia, continental", echo=FALSE, fig.cap="Smaller original bins, genera, Eurasia, continental"}
...
```{r "paleoTS with different time bins, no bins, genera, Eurasia, insular", echo=FALSE, fig.cap="Smaller original bins, genera, Eurasia, insular"}
