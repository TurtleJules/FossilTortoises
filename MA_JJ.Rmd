...
# paleoTS plot with species mean, including island species
...
kable(PaleoSpecFit, caption="Model-fitting results for testudinidae, individuals, including island species")

```


\newpage
# paleoTS plot with genus mean
...
kable(PaleoGenFit, caption="Model-fitting results for testudinidae, individuals, including island species")
...
kable(PaleoPCCLIsFit, caption="Model-fitting results for testudinidae, individuals, including island species")
...
# paleoTS plot with species mean, excluding island species
...
paleoSpecIs <-as.paleoTS(SpecPaleoIs$mm, SpecPaleoIs$vv, SpecPaleoIs$nn, SpecPaleoIs$tt, MM = NULL, genpars = NULL, label = "Testudinidae body size evolution mode, Holocene-Upper Miocene, species mean CL", reset.time=TRUE)
...
kable(PaleoSpecIsFit, caption="Model-fitting results for testudinidae, individuals, including island species")
...
kable(PaleoGenIsFit, caption="Model-fitting results for testudinidae, individuals, including island species")
...
```{r "Boxplots, genera summarised", echo=FALSE, fig.cap="Boxplots continental vs. insular, genera summarised"}
Island <- PleiPlioCL %>%
  dplyr::select(Taxon, CL, PL, Age, Island, Continent, EpochBins) %>%
  merge(Epochs) %>%
  merge(Continents) %>%
...
```{r "Boxplot continental vs. insular, species summarised", echo=FALSE, fig.cap="Boxplot continental vs. insular, species summarised"}
Island <- PleiPlioCL %>%
