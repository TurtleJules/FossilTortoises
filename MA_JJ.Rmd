...
Stats$Variable <- c("all", "Modern", "Upper Pleistocene", "Middle Pleistocene", "Lower Pleistocene", "Gelasian", "Piacencian", "Zanclean", "Messinian","Tortonian", "Serravallian","Langhian",
                         "Burdigalian", "Modern","Fossil", "continental", "insular","modern-con",
                    "modern-ins", "fossil-con", "fossil-ins",  "Africa", "America", "Asia", "Europe")
...
FossilRandom <- sample(FossilR$CL, 251, replace=FALSE)
Modern <- as.vector(ModernR$CL[which(ModernR$EPOCH=="Modern")])

FossilRan <- mean(replicate(100, {
 sample(FossilR$CL, 251, replace=FALSE)
  }))
