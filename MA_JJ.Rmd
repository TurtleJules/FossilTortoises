...
```{r "Histograms of body size data, split by continents", echo=FALSE, fig.cap="Distribution of body site data of continental (n) and insular(y) species, logtransformed."}
...
kable(PaleoPCCLConFit, caption="Model-fitting results for testudinidae, individuals, America")
