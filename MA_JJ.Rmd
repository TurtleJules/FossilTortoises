...
Stats <- bind_rows(StatsAll, StatsBins, StatsFossil, StatsIsland, StatsContinents) %>%
...
Stats$Variable <- c("all", "Modern", "Upper Pleistocene", "Middle Pleistocene", "Lower Pleistocene", "Upper Pliocene", "Lower Pliocene", "Upper Miocene", "Middle Miocene", "Lower Miocene", "Oligocene and Eocene","Fossil", "Modern", "continental", "insular", "Africa", "America", "Asia", "Europe")
