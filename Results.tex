...
%Body size within the Pleistocene and between Pleistocene .... does not differ.
...
The time-scale analysis was repeated for sufficiently sampled continents, Europe and Eurasia.
...
The results for Eurasian taxa only generally coincide with the results for the complete data set. 
...
%, althought the drop during is the Pleistocene is much more pronounced in continental European testudinids (Fig. \ref{fig:pTSEuC}), while it is a lot less pronounced in insular European testudinids (Fig. \ref{fig:pTSEuI}). Also, the highest carapace length for European testudinids are found during the Lower Pliocene and Upper Miocene (Table \ref{tab:pTSEu}, \ref{tab:pTSEuC}, \ref{tab:pTSEuI})
